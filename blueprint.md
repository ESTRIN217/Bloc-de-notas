...
- **Floating Note Window:**
    - **Picture-in-Picture Mode:** When a single note is selected, the user can tap an icon to display that note in a draggable, floating window that stays on top of the main screen for quick reference.
