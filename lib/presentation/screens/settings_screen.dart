              ...
              return ListView(
                ...
                children: [
                  SettingsSectionTitle(
                    title: AppLocalizations.of(context)!.apariencia,
                  ),
                  ...
                  SettingsCardGroup(
                    child: ListTile(
                      leading: const SettingsIconContainer(
                  ...
                  SettingsSectionTitle(
                    title: AppLocalizations.of(context)!.titleSeccionBackup,
                  ),
                  SettingsCardGroup(
                    child: ListTile(
                  ...
                  SettingsSectionTitle(
                    title: AppLocalizations.of(context)!.informacion,
                  ),
                  if (!kIsWeb)
                    SettingsCardGroup(
                      child:
